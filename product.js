...
function myFunction(e) {
  ...
  let productFil = products.filter( (a) => {
    ...
    return(
      ...
      <div class="">
        <img id="img1" class="card-img-top " src="${a.url}" alt="Card image cap">
      </div>
      <div class="card-body align-self-center">
      ...
      <div class="row card-body justify-content-center">
        ...
        <a href="#" onclick="addToCart2(${a.id})" class="btn btn-primary col-md-6" style=" font-size: 14px;">Add to Cart</a>
     </div>
    </div>
